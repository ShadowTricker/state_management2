...
import 'package:state_management2/containers/origin/async_futureBuilder.dart';
import 'package:state_management2/containers/origin/async_streamBuilder.dart';
...
Map<String, WidgetBuilder> originRoutes(context) {
  return {
    ...
    '/origin/futurebuilder': (context) => FutureBuilderPage(),
    '/origin/streambuilder': (context) => StreamBuilderPage(),
